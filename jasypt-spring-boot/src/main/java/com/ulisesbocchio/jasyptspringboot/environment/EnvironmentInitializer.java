...
public class EnvironmentInitializer {
    ...
    public EnvironmentInitializer(ConfigurableEnvironment environment, InterceptionMode interceptionMode, SkipPropertySourceFilter skipPropertySourceFilter, EncryptablePropertyResolver resolver, EncryptablePropertyFilter filter, StringEncryptor encryptor, EncryptablePropertyDetector detector) {

        this.environment = environment;
        this.interceptionMode = interceptionMode;
        this.skipPropertySourceFilter = skipPropertySourceFilter;
        this.resolver = resolver;
        this.filter = filter;
        this.encryptor = encryptor;
        this.detector = detector;
    ...
    MutablePropertySources initialize(MutablePropertySources originalPropertySources) {
        ...
        EncryptablePropertySourceConverter converter = new EncryptablePropertySourceConverter(actualInterceptionMode, skipPropertySourceFilter, actualResolver, actualFilter);
