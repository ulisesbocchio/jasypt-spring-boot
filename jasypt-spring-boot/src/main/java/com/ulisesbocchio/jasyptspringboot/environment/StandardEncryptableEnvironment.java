...
public class StandardEncryptableEnvironment extends StandardEnvironment implements ConfigurableEnvironment {
     ...
     */
    @Builder
    public StandardEncryptableEnvironment(InterceptionMode interceptionMode, SkipPropertySourceFilter skipPropertySourceFilter, EncryptablePropertyResolver resolver, EncryptablePropertyFilter filter, StringEncryptor encryptor, EncryptablePropertyDetector detector) {
